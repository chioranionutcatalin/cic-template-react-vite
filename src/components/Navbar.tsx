...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className="sticky top-0 z-50 bg-stone-50 border-b border-stone-200">
          ...
          <div className="hidden md:flex space-x-8">
            {navLinks.map(({ HREF, NAME }) => (
              <a
                ...
                className="text-shoe-black hover:text-shoe-brown px-3 py-2 body-text transition-colors"
              >
                <h1 className="text-shoe-brown font-bold">{NAME}</h1>
              </a>
            ))}
          </div>
